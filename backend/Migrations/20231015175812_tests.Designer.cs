...
namespace buyC.Migrations
{
    ...
    [Migration("20231015175812_tests")]
    partial class tests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("buyC.Models.Shoe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9409),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9410),
                        ...
                        {
                            Id = 3,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9412),
                            Description = "A stylish and comfortable casual shoe.",
                        ...
                        {
                            Id = 4,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9414),
                            Description = "A stylish and comfortable casual shoe.",
                        ...
                        {
                            Id = 5,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9416),
                            Description = "A stylish and comfortable casual shoe.",
                        ...
                        {
                            Id = 6,
                            Date = new DateTime(2023, 10, 15, 17, 58, 12, 378, DateTimeKind.Utc).AddTicks(9417),
                            Description = "A stylish and comfortable casual shoe.",
